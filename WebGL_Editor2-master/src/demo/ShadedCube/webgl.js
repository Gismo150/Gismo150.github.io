...
function render(){
    ...
    //incremenmt theta for each frame
    theta +=0.01;
    //rotate the modelMatrix by theta around x- and z-axis
    mat4.fromRotation(modelMatrix, theta, vec3.fromValues(1,0,1));
    // mat4.fromYRotation(modelMatrix, theta);

    gl.uniformMatrix4fv(modelPosition, false, modelMatrix);
    // NOTE
    // you can debug vertices like
